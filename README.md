...
## Problem Statement #41 – OpenAPI Mock Server Generator
...
- API Developer
- QA Engineer
- API Client (derived external actor for interaction with generated mock REST endpoints)

## Deliverables
1. Requirements Table – exactly 5 Functional Requirements and 2 Non-Functional Requirements.
